...
const Gui = @import("editor/gui.zig");
const Wgpu = @import("wgpu.zig");
const config = @import("config.zig");
const Consumer = @import("consumer.zig");
const Producer = @import("producer.zig");
const ConsumerHover = @import("editor/consumer_hover.zig");
const Image = @import("editor/images.zig");
const Camera = @import("camera.zig");
const Square = @import("square.zig");
const Circle = @import("circle.zig");
const Mouse = @import("editor/mouse.zig");
const Hover = @import("editor/hover.zig");
const Popups = @import("editor/popups.zig");
